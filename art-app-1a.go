...
func main() {
	...
	_, _, _, err = canvas.AddShape(validateNum, blockartlib.PATH, "M 0 5 H 5", "transparent", "red")
	checkError(err)
	...
	_, _, _, err = canvas.AddShape(validateNum, blockartlib.PATH, "M 5 0 V 5", "transparent", "red")
	checkError(err)
